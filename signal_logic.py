...
class SignalLogic:
    def __init__(self, scoring_system=None, helius_client=None, gmgn_client=None, rugcheck_api=None, ml_predictor=None):
        ...
        self.last_cleanup = time.time()  # Para control de limpieza de datos antiguos
    ...
    # Nota: Asegúrate de que el resto de la lógica para generar señales (en _generate_signals) esté implementada.
